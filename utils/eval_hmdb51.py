...
class HMDBclassification(object):
    ...
    def __init__(self, ground_truth_filename='/data/users/yangke/yangke-data/dataset/hmdb51/hmdb_val_list03.csv',
    ...
    def _import_ground_truth(self, ground_truth_filename):
        ...
        file_path="/data/users/yangke/yangke-data/dataset/hmdb51/hmdb_val_list03.csv"
...
val=HMDBclassification(prediction_filename='./test_save_37_2/val.json', verbose=True, top_k=5)
val.evaluate()
