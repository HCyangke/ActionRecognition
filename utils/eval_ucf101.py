...
class UCFclassification(object):
    ...
    def __init__(self, ground_truth_filename='/data/users/yangke/yangke-data/dataset/ucf101/ucf_val_list_01.csv',
    ...
    def _import_ground_truth(self, ground_truth_filename):
        ...
        activity_index={}
        index=0
        with open('/data/users/yangke/yangke-data/dataset/ucf101/ucf_label.csv','r') as myFile:
            lines=csv.reader(myFile)
            for line in lines:
                activity_index[line[0]]=index
                index+=1
        ...
        file_path="/data/users/yangke/yangke-data/dataset/ucf101/ucf_val_list_01.csv"
        with open(file_path,'r') as myFile:
            lines=csv.reader(myFile)
            for line in lines:
                video_lst.append(line[2])
                label_lst.append(activity_index[line[1]])
...
val=UCFclassification(prediction_filename='/data/users/yangke/workspace/3D-ResNets-PyTorch-master/test_save_split1/val.json', verbose=True, top_k=5)
val.evaluate()
